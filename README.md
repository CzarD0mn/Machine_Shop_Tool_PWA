...
Workflows run from [`.github/workflows/`](.github/workflows/).

| Workflow | Trigger | What it does |
| --- | --- | --- |
| [CI](.github/workflows/ci.yml) | Push, PR | `npm ci`, TypeScript check, Vite PWA build, upload `dist` |
| [Deploy GitHub Pages](.github/workflows/pages.yml) | Push to `main` | Builds with `VITE_BASE=/Machine_Shop_Tool_PWA/` and publishes Pages |
| [Build Android APK](.github/workflows/build-apk.yml) | Push to `main` | Capacitor debug APK artifact |

Enable Pages once: **Settings → Pages → Source: GitHub Actions**. Private-repo Pages needs GitHub Pro. After that the shop PWA is at:

`https://CzarD0mn.github.io/Machine_Shop_Tool_PWA/`
